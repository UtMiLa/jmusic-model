...
import { AbsoluteTime, Score, ScoreDef, Time, voiceContentToSequence } from './../../model';
...
export function createStateMap(score: Score):  IndexedMap<StateChange, ScopedTimeKey> {
